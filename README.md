# @ellentorg/maxime-ut-id

> forked from [@ellentorg/maxime-ut-idode](https://www.npmjs.com/package/@ellentorg/maxime-ut-idode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@ellentorg/maxime-ut-idode/issues/300).

[![npm version](https://img.shields.io/npm/v/@ellentorg/maxime-ut-id.svg)](https://www.npmjs.com/package/@ellentorg/maxime-ut-id)
[![Downloads](https://img.shields.io/npm/dm/@ellentorg/maxime-ut-id.svg)](https://www.npmjs.com/package/@ellentorg/maxime-ut-id)
[![Build Status](https://github.com/ellentorg/maxime-ut-id/workflows/CI/badge.svg)](https://github.com/ellentorg/maxime-ut-id/actions)
...
```sh
npm install --save-dev eslint @ellentorg/maxime-ut-id
```
...
```js
const nodePlugin = require("@ellentorg/maxime-ut-id")
...
💼 [Configurations](https://github.com/ellentorg/maxime-ut-id#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/ellentorg/maxime-ut-id#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/ellentorg/maxime-ut-id#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/ellentorg/maxime-ut-id#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/ellentorg/maxime-ut-id#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/ellentorg/maxime-ut-id#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/ellentorg/maxime-ut-id#-configs).\
...
`@ellentorg/maxime-ut-id` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/ellentorg/maxime-ut-id/releases)
